    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "node",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="telemetry_readings", to="max.node"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "neighbour",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="heard_by", to="max.node"),
                ),
                (
                    "node",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="neighbours", to="max.node"),
                ),
            ],
            options={
